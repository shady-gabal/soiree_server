...
var customSchema = new Schema({
        ...
        _cahGame : {type: ObjectId, ref: "CAHGame", autopopulate: true}
    },
...
customSchema.methods.status = function(){
  return {
      "nextCahGame" : this.nextScheduledCahGame
  };
};
...
customSchema.methods.start = function(){
    ...
    if (!this.started){
        this.started = true;
        //if (!this._cahGame){
        //    this._cahGame = CAHGame.createGame(this);
        //}
