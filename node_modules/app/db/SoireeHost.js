...
customSchema.methods.sendWelcomeMessagesToUser = function(socket) {
    ...
    var welcomeMessages = createMessages([
        ...
        " At " + Globals.SOIREE_LOWERCASE + "s, there is no reason to be shy. Walk around and introduce yourself to your fellow " + Globals.SOIREE_LOWERCASE + "goers",
        "Trust us, they're amazing people. We hope you have a great time!",
        "Not sure how to introduce yourself? Want something to spark conversation? Tap below to get a fun question to ask to spark it up again.",
...
customSchema.methods.requestingStartCAH = function(socket, callback){
