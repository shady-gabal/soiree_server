...
var businessSchema = new Schema({
        ...
        colleges : [{type: String, enum: User.colleges}],
...
businessSchema.statics.nextBusinessToHostSoiree = function(college, successCallback, errorCallback){
    ...
    this.find({colleges:college}, function(err, businesses){
