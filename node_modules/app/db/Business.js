...
businessSchema.methods.addNewReservation = function(reservation){
    ArrayHelper.pushOnlyOncePopulated(this, "_unconfirmedReservations", reservation);
    return this.save();
};

businessSchema.methods.chargedUnchargedReservation = function(reservation){
    //console.log(this._unconfirmedReservations);
    //console.log(this);
    //ArrayHelper.pushOnlyOncePopulated(this, "_unconfirmedReservations", reservation);
