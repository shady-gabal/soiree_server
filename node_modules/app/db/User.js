...
var userSchema = new Schema({
		...
		currentSoireeAccessToken : {type: String, index: true},
...
userSchema.methods.validateSoireeAccessToken = function(encodedAccessToken, callback){
	if (!this.currentSoireeAccessToken) return callback(null, false);
	...
	if (accessToken){
		if (this.currentSoireeAccessToken === accessToken){
...
userSchema.methods.generateNewSoireeAccessToken = function(){
	...
	this.currentSoireeAccessToken = accessToken;
