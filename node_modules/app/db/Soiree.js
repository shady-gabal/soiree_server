...
soireeSchema.statics.createLunch = function(successCallback, errorCallback, options) {
	...
	determineDateForSoireeType(soireeType, function(date){
...
soireeSchema.statics.findSoirees = function(req, user, successCallback, errorCallback){
	...
	if (req.body.user.longitude && req.body.user.latitude){
...
soireeSchema.methods.cancel = function(){
	if (!this.cancelled && !Globals.soireesCancelling[this.soireeId]) {
		...
		this.deepPopulate("_chargedReservations _usersUncharged _usersAttending", function (err, soiree) {
			if (err) {
...
function determineDateForSoireeType(soireeType,callback){
	...
	if (!timeCountsPerSoireeType[soireeType]){
		countsForSoireeTypeAtTimes(soireeType, dateCallback);
	}
	else{
