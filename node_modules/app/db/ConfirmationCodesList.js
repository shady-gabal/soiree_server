...
var customSchema = new Schema({
        confirmationCodes : [{confirmationCode: String, email: String, name : String, gender : String, os : String}]
    },
...
customSchema.statics.createConfirmationCode = function(data, successCallback, errorCallback){
    ...
    this.getList(function(list){
        ...
        var obj = {confirmationCode : code, email : email, os : os, gender : gender, name : name};
