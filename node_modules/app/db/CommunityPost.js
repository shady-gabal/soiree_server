...
var postSchema = new Schema({
        ...
        _user : {type: ObjectId, ref:"User", autopopulate: {select : "firstName lastName profilePictureUrl college _id"}}
},
...
postSchema.statics.findPostsForUserId = function(userId, successCallback, errorCallback) {
    ...
    User.findOne({userId : userId}, function(err, user){
        if (err){
            ...
            CommunityPost.find({_user : user._id}).exec(function(err2, posts){
               if (err){
                   console.log(err2);
                   errorCallback(ErrorCodes.ErrorQuerying);
               }
