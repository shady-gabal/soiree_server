...
postSchema.statics.emotionPostWithId = function(postId, user, emotion, successCallback, errorCallback) {
    ...
    this.findOneAndUpdate({postId : postId}, {"$addToSet" : {emotionArr : user._id} }, {new : true}, function(err, newDoc){
...
postSchema.statics.unemotionPostWithId = function(postId, user, emotion, successCallback, errorCallback) {
    ...
    this.findOneAndUpdate({postId : postId}, {"$pull" : {emotionArr : user._id} }, {new : true}, function(err, newDoc){
        console.log(newDoc._loves);
        console.log(newDoc._angries);
        if (err){
            console.log(err);
