...
var postSchema = new Schema({
        ...
        testNumLoves : {type: Number, default : -1},
        testNumAngries : {type: Number, default: -1}
},
...
postSchema.statics.upvotePostWithId = function(postId, user, successCallback, errorCallback) {
    ...
    this.findOneAndUpdate({postId : postId}, updateQuery, {new : true}, function(err, newDoc){
        if (err){
            console.log(err);
            return errorCallback(ErrorCodes.MongoError);
        }
        else{
            console.log(newDoc._upvotes);
...
//postSchema.statics.emotionPostWithId = function(postId, user, vote, successCallback, errorCallback) {
//    if (!user || !postId || !vote){
//        return errorCallback(ErrorCodes.MissingData);
//    }
//
...
//
//    if (vote === "love"){
//        console.log("adding " + vote + " with user " + user._id);
//        updateQuery = {"$addToSet" : {"_upvotes" : user._id} };
//    }
//    else if (vote === "angry"){
//        console.log("adding " + vote + " with user " + user._id);
//        updateQuery = {"$addToSet" : {"_angries" : user._id} };
//}
//    else{
...
//
//
//postSchema.statics.unemotionPostWithId = function(postId, user, vote, successCallback, errorCallback) {
//    if (!user || !postId || !vote){
//        return errorCallback(ErrorCodes.MissingData);
//    }
//
...
//
//    if (vote === "love"){
//        console.log("removing " + vote + " with user " + user._id);
//        updateQuery = {"$pull" : {"_upvotes" : user._id} };
//    }
//    else if (vote === "angry"){
//        console.log("removing " + vote + " with user " + user._id);
//        updateQuery = {"$pull" : {"_angries" : user._id} };
//    }
//    else{
//        return errorCallback(ErrorCodes.InvalidInput);
//    }
...
//postSchema.methods.unemotion = function(user, vote, successCallback, errorCallback) {
//    if (vote === "love"){
