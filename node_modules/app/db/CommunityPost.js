...
var postSchema = new Schema({
        ...
        _user : {type: ObjectId, ref:"User", autopopulate: {select : "firstName lastName profilePictureUrl"}}
},
...
postSchema.statics.findPosts = function(req, coors, user, successCallback, errorCallback){
    ...
    //
    //}
    var query = this.find(constraints).sort('-dateCreated').limit(numPostsToFetch);
