...
postSchema.statics.emotionPostWithId = function(postId, user, emotion, successCallback, errorCallback) {
    if (!user || !postId || !emotion){
    ...
    if (emotion === "love"){
        ...
        updateQuery = {"$addToSet" : {"_loves" : user._id} };
    }
...
postSchema.statics.unemotionPostWithId = function(postId, user, emotion, successCallback, errorCallback) {
    if (!user || !postId || !emotion){
        return errorCallback(ErrorCodes.MissingData);
    }
    ...
    if (emotion === "love"){
        ...
        updateQuery = {"$pull" : {"_loves" : user._id} };
    }
    else if (emotion === "angry"){
        console.log("removing " + emotion + " with user " + user._id);
