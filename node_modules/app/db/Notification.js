...
notificationSchema.statics.createSoireeFeedbackNotification = function(soiree, notificationsUser){
    var Notification = this;
    var message;
    if(notificationsUser.firstName){
        message = notificationsUser.firstName + ", how was your " + Globals.SOIREE_LOWERCASE + "? We love hearing feedback and read every word."
    }
    else{
        message = "How was your " + Globals.SOIREE_LOWERCASE + "?  We love hearing feedback and read every word.";
    }
    var newNotification = new Notification({
        bodySuffix : message,
        _user : notificationsUser._id,
