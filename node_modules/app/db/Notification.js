...
var notificationTypes = ["commented", "liked", "soireeCancelled", "soireeReminder", "soireeStarting", "soireeConfirmed", "userVerified", "userRejected"];
...
notificationSchema.statics.createUserVerifiedNotification = function(user){
    ...
    var newNotification = new Notification({
       bodySuffix: message,
        _user : user._id,
        notificationType : Notification.notificationTypes.userVerified,
        _id : generateId(user, "" + Date.now(), Notification.notificationTypes.userVerified),
        title: "Verified!"
    });
...
notificationSchema.statics.createUserRejectedNotification = function(user, reason){
    ...
    var Notification = this;
    var message = "It looks like there was a problem with your user verification. It was rejected because " + reason;
