...
var notificationTypes = ["commented", "liked", "soireeCancelled", "soireeReminder", "soireeStarting", "soireeConfirmed", "userAccepted", "userRejected", "test"];
...
notificationSchema.statics.jsonArrayFromArray = function(_notifications) {
    ...
    //console.log('json array: ' + notifications);
...
notificationSchema.pre('remove', function(next){
    User.findOne({_user : this._user}).exec(function(err, user){
       if (err){
           console.log(err);
       }
        else{
