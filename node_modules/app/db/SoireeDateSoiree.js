...
customSchema.statics.createSoireeDateSoiree = function(successCallback, errorCallback, options) {
    ...
    SoireeDateSoiree.determineDateForSoireeType(soireeType, function(date){
        ...
        var soiree = new SoireeDateSoiree({
