...
//var pushNotificationHelper = (function() {
    ...
    var certName = Globals.production ? "certificates/production_cert.pem" :  "certificates/cert.pem";
    var keyName = Globals.production ? "certificates/production_key.pem" : "certificates/key.pem";

    var options = {
        "cert": certName,
        "key": keyName,
        "passphrase": "appleB@nana69",
    ...
    var pushNotificationHelper =  {
        ...
        sendSoireeScoreNotification : function(user){
            var payload = {"soireeScore" : user.soireeScore};
            this.sendPushNotification(user, "", payload, {"content-available" : 1,
                sound : ""});
        }
