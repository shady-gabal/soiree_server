/**
 * Created by shadygabal on 7/2/16.
 */
/**
...
var idHelper = (function() {
    ...
    return {
        generateId : function(len, options){
            ...
            if (options.addLowerCase && !options.addLowercase)
                options.addLowercase = options.addLowerCase;
            if (options.onlyLowerCase && !options.onlyLowercase)
                options.onlyLowercase = options.onlyLowerCase;
