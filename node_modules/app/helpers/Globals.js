...
var Globals = {
    ...
    test : env === 'test',
    devOrTest : (this.development || this.test),
    ...
    soireeTypes : ["dinner", "drinks", "soiree date", "test", "movie"],
    initialChargePerSoireeType : {"dinner" : 99, "drinks" : 99, "soiree date" : 99, "test" : 99, "movie" : 99},
    availableTimesPerSoireeType : {
        ...
        "soiree date" : ["7:00 PM", "8:00 PM", "9:00 PM", "1:00 AM", "5:00 AM"],
    ...
    numUsersMaxPerSoireeType : {"dinner" : 10, "drinks" : 20, "soiree date" : 40, "test" : 3, "movie" : 6},
    numUsersMinPerSoireeType : {"dinner" : 5, "drinks" : 8, "soiree date" : 15, "test" : 2, "movie" : 3},
