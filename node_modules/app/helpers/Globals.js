...
var Globals = {
    ...
    /* Soirees */
    soireeTypes : this.development ? ["dinner", "drinks", "soiree_date", "test", "movie"] : ["drinks"],
    ...
    soireeCategoriesPerSoireeType: {
        "drinks" : "social_soirees",
        "dinner" : "social_soirees",
        "movie" : "movie_soirees",
        "soiree_date" : "soirees_for_singles"
    },
    soireeCategoryDisplayNames : {
        "social_soirees" : "Social Soirées",
        "movie_soirees" : "Movie Soirées",
        "soirees_for_singles" : "Soirées for Singles"
    },
    soireeRestrictions : ["drinking_age"], //when adding a restriction, make sure to add error message below and implement handling in Soiree.userPassesRestrictions
    soireeRestrictionsErrorMessages : {
        "drinking_age" : "You must be 21+ to sign up for this Soirée."
    },
    defaultRestrictionsPerSoireeType : {
        "drinks" : ["drinking_age"]
    },
