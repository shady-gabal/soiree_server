 ...
 */
    ...
    var emailHelper = {
        ...
        sendBetaSignupEmail : function(email, gender, os){
            var body, html;
            if (os === 'ios'){
                html = "Thanks for signing up for Soiree - the future of making real-world friends and memories. We are putting the final touches on our beta and will be launching any day now, so stay tuned!<br /><br /><strong>xoxo,<br />your friends at Soirée</strong><br /><br /><br />" +
                    "<p style='font-size:12px;'>Psst! Interested in partnering with Soiree? <br /> Join the many businesses that are lining up to be a part of the future of safe, real connections. Email us at: <a href=\"mailto:business@experiencesoiree.com\">business@experiencesoiree.com</a></p>";
                body = "Thanks for signing up for Soiree - the future of making real-world friends and memories. We are putting the final touches on our beta and will be launching any day now, so stay tuned!\n\nxoxo,\nyour friends at Soirée\n\n" + "Psst! Interested in partnering with Soiree? \n Join the many businesses that are lining up to be a part of the future of safe, real connections. Email us at: business@experiencesoiree.com";
            }
            else{
                ...
                body = "Thanks for signing up for Soiree - the future of making real-world friends and memories. Unfortunately, our upcoming beta is only for iOS (we <3 our Android people, but we couldn't make two apps simultaneously and have them both have the awesome experience we want). \n\n However, as we speak, an overworked coder somewhere in his parents' basement is working on the Android app, so stay tuned!\n\nxoxo,\n your friends at Soirée \n\n" +
                    "Psst! Interested in partnering with Soiree? \n Join the many businesses that are lining up to be a part of the future of safe, real connections. Email us at: <a href=\"mailto:business@experiencesoiree.com\">business@experiencesoiree.com</a>";
            }
        ...
        sendEmail : function(email, subject, body, html, successCallback, errorCallback){
            return this.sendMail(email, subject, body, html, successCallback, errorCallback);
        },
        sendMail : function(email, subject, body, html, successCallback, errorCallback){
            ...
            transporter.sendMail(mailOptions, function(error, info){
                if(error){
                    console.log(error);
                    if (errorCallback) errorCallback(ErrorCodes.Error);
                }
                else {
        ...
        sendEmailReservationConfirmation : function(email, code, successCallback, errorCallback){
            var subject = "Your Soirée Reservation - August 11th";

            var body = "Thanks for signing up for the first ever Soirée on August 11th, 2016 at 6:30 PM. Please make sure to arrive on time. When you get there, give this code to the venue and you will be allowed in: \n\nConfirmation Code:" + code;

            var html = "Thanks for signing up for the first ever Soirée on August 11th, 2016 at 6:30 PM. Please make sure to arrive on time. When you get there, give this code to the venue and you will be allowed in: <br /><br /> Confirmation Code: <strong>" + code + "</strong><br /><br /> xoxo, <br /> the team at Soirée";

            this.sendEmail(email, subject, body, html, successCallback, errorCallback);
        },
