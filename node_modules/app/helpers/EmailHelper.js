...
var emailHelper = (function() {
    ...
    return {
        ...
        sendBetaSignupEmail : function(email, gender, os){
            var body, html;
            if (os === 'ios'){
                html = "Thanks for signing up for Soiree - the future of making real-world friends and memories. We are putting the final touches on our beta and will be launching any day now, so stay tuned!<br /><br /><strong>xoxo,<br />your friends at Soirée</strong><br /><br /><br /><br />" +
                    "<p style='font-size:10px;'>Psst! Interested in partnering with Soiree? <br /> Join the many businesses that are lining up to be a part of the future of safe, real connections. Email us at: <a href=\"mailto:business@experiencesoiree.com\">business@experiencesoiree.com</a></p>";
