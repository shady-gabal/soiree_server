...
var dateHelper = {
        ...
        dateFromTime : function(str){
            return moment(str, "h:mm A");
        },
        timeStringFromDate : function(date){
            return moment(date).format("h:mm A");
        },
        minutesFromMilliseconds : function(ms){
            return ms / (60 * 1000);
        },
        hoursFromMilliseconds : function(ms){
            return ms / (60 * 60 * 1000);
        },
        dateFromFormat : function(str, format){
            var date = moment(str, format);
            console.log(" date " + date + " for string " + str + " format " + format);
