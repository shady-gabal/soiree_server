...
var idHelper = (function() {
    ...
    return {
        generateId : function(len, addLowercase){
            ...
            var letters = lettersStr.toUpperCase().split(""); //No o,i
            if (addLowercase){
                letters.concat(lettersStr.toLowerCase().split(""));
            }
        ...
        generateUniqueId: function(modelName, field, doc, next){
            var len = 10;
            var id = this.generateId(len, false);
