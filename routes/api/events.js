...
router.post('/soireesNear', function(req, res){
  res.json(
      {"events":[
          {"category" : "Lunch", "timeString" : "Today at 2:00 PM", "numSpotsLeft" : 3, "distance" : "0.3 mi away"},
        ...
        {"category" : "Lunch", "timeString" : "Today at 12:30 PM", "people" : "1 spot left", "distance" : "0.3 mi away"},
         ...
         {"category" : "Drinks", "timeString" : "Tonight at 9:00 PM", "people" : "2 spots left", "distanceString" : "0.7 mi away"}
        ]
    }
    );
});
